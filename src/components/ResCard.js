        ...
        <div  className='res-wrapper flex flex-wrap w-[200px] m-3 bg-gray-200 p-2.5 rounded-md' data-testid="card">
            ...
            <p className='rating'>
                <span className='rating-icon'>
                    ...
                    <stop stop-color="#21973B"></stop><stop offset="1" stop-color="#128540"></stop></linearGradient></defs></svg>
                </span>
                {info.avgRating}
                <span className='delivery-time'><strong>{info.sla.slaString}</strong></span>
            </p>
